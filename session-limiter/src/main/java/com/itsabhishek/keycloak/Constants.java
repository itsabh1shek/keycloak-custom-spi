...
public class Constants {
    ...
    public static final String USER_REALM_LIMIT_HELP_TEXT = "Maximum concurrent sessions for a user in a realm";
    public static final String USER_REALM_LIMIT_LABEL = "Maximum concurrent sessions";
    public static final String ACTION = "action";
    public static final String ACTION_LABEL = "Action";
    public static final String ACTION_LABEL_HELP_TEXT = "Action when user session limit is exceeded";
